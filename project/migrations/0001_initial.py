...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('project_stripecontent', (
        ...
        db.send_create_signal('project', ['StripeContent'])

        # Adding unique constraint on 'StripeContent', fields ['container', 'moderate_state']
        db.create_unique('project_stripecontent', ['container_id', 'moderate_state_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StripeContent', fields ['container', 'moderate_state']
        db.delete_unique('project_stripecontent', ['container_id', 'moderate_state_id'])

        # Deleting model 'StripeContent'
        db.delete_table('project_stripecontent')
